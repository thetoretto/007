...
import { Calendar, Map, Users, Clock, AlertCircle, CheckCircle, Plus, Edit, Trash2 } from 'react-feather';
      ...
      <div className="md:flex md:items-center md:justify-between mb-6">
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage all trips across the platform
          </p>
        </div>
        ...
        <div className="overflow-hidden">
          {detailedTrips.length > 0 ? (
                  ...
                  {selectedTrip === trip.id && (
                    <div className="mt-4 pt-4 border-t border-gray-100 animate-fade-in">
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        <h5 className="text-sm font-medium text-gray-900 mb-2">Assigned Driver</h5>
                        <div className="flex items-center">
                          <div className="h-10 w-10 rounded-full bg-primary-100 flex items-center justify-center">
                            <span className="text-primary-800 font-medium">RJ</span>
                          </div>
                          <div className="ml-3">
                            <p className="text-sm font-medium text-gray-900">Robert Johnson</p>
                            <p className="text-xs text-gray-500">robert.j@example.com</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                There are no trips in the system at the moment.
              </p>
              <div className="mt-6">
                <Link to="/admin/trips/new" className="btn btn-primary">
                  Create New Trip
